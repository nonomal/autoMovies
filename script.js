...
// @require     https://cdn.jsdelivr.net/npm/artplayer-plugin-hls-quality/dist/artplayer-plugin-hls-quality.js
// @require     https://cdn.jsdelivr.net/npm/hls.js@canary
// @version     1.0
// @author      -
// @description 2023/2/5 18:46:05
// ==/UserScript==
...
(function () {
  ...
  `
    ...
    let testDownloadSource = ['https://pps.shanshanku.com/20220705/iS7EWI78/1200kb/hls/DTueaTFd.ts',//测试下载源
      'https://pps.shanshanku.com/20220705/iS7EWI78/1200kb/hls/oH4CXhnE.ts',
      'https://pps.shanshanku.com/20220705/iS7EWI78/1200kb/hls/HGieLNSs.ts',
      'https://pps.shanshanku.com/20220705/iS7EWI78/1200kb/hls/Dn0jkwTV.ts',
      'https://pps.shanshanku.com/20220705/iS7EWI78/1200kb/hls/nQuoYFp9.ts',
      'https://pps.shanshanku.com/20220705/iS7EWI78/1200kb/hls/hIVSQcgd.ts',
      'https://pps.shanshanku.com/20220705/iS7EWI78/1200kb/hls/LSlCywWt.ts',
      'https://pps.shanshanku.com/20220705/iS7EWI78/1200kb/hls/qzJQuFIB.ts',
      'https://pps.shanshanku.com/20220705/iS7EWI78/1200kb/hls/LN9MQyEu.ts',
      'https://pps.shanshanku.com/20220705/iS7EWI78/1200kb/hls/s9RBr98r.ts']
    let containerClass = ".artplayer-app"//包装器的class
    let artplayerContainer = `
  <div class="liu-playContainer">
    <a class="liu-closePlayer">点击关闭播放</a>
    ...
    function search(url, videoName) {
      ...
      return new Promise((resolve, reject) => {
        GM_xmlhttpRequest({
          method: "GET",
          url: `${url}?ac=detail&wd=${videoName}`,
          onload: function (r) {
            try {
    ...
    async function go(SearchSource) {
      ...
      await createSourceButton(videoName)
    }
